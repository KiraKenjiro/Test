				...
				a = t
					? [...e].reverse().findIndex(({ char: e }) => {
							let n = e.parentElement,
								r = n.matches(t);
							return (
								!(!i || !r) || (r && n.firstChild.isSameNode(e))
							);
					  })
					: -1;
		...
		let L = async (e, t, n = !1) => {
			...
			I = (e) =>
				((e, t) => {
					if (!e) return;
					let n = e.parentNode;
					(n.childNodes.length > 1 || n.isSameNode(t)
						? e
						: n
					).remove();
				})(e, J),
			...
			$ = () =>
				((e) =>
					b(e)
						? n(e.value)
						: d(e, !0).filter((e) => !(e.childNodes.length > 0)))(
					J
				),
			H = (e, t) => (
				ee.add(e),
			...
			(this.delete = function (e = null, t = {}) {
				...
				return H(
					[
						n[0],
						...S(
							{ func: Q, delay: i ? 0 : A(1), deletable: !0 },
							s
						),
						n[1],
					],
		...
		r.cursor = ((e) => {
			if ("object" == typeof e) {
				...
				return (
					...
					(t.autoPauseDelay =
						e.autoPauseDelay || u.cursor.autoPauseDelay),
					t
				);
			}
				...
				return (
					n(e),
					{
						...
						destroy: (e) => a.delete(e),
							...
							t ? a.delete(e) : (a.get(e).done = !0),
						getItems: (e = !1) =>
							e ? i() : i().filter((e) => !e.done),
						getQueue: () => a,
